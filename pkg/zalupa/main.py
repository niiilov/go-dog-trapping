...
headers = [
    ...
    "Сведения о количестве животных без владельцев, поведение, срочность"
]
...
data = [
    ...
    "И.о. начальника Введенского территориального отдела И.В.Денисов , заявка от 18.08.2025 №348",
...
# Контакты
doc.add_paragraph("\nКонтактное лицо: И.о. начальника Введенского территориального отдела Денисов И.В. т. 75-60-21")

# Подпись
doc.add_paragraph("\nЗаместитель председателя комитета энергетики и ЖКХ\nадминистрации Липецкого муниципального округа")
doc.add_paragraph("Е.А. Челидина\n\n34-57-29")
